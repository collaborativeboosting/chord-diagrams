...
function convertValue(value, outername) {
	...
	if (outername == "SB" && value == 416)
		return "34.78";
	if (outername == "SB " && value == 652)
		return "54.55";
	if (outername == "SB  " && value == 149)
		return "12.50";
	if (outername == "SB   " && value == 398)
		return "33.33";
	if (outername == "SB    " && value == 398)
		return "33.33";
	if (outername == "SB     " && value == 341)
		return "28.57";
	if (outername == "SB      " && value == 896)
		return "75.00";
	if (outername == "SB       " && value == 82)
		return "6.90";
	if (outername == "SB        " && value == 796)
		return "66.67";
	
	if (outername == "GB" && value == 199)
		return "16.67";
	if (outername == "GB " && value == 652)
		return "54.55";
	if (outername == "GB  " && value == 291)
		return "24.32";
	if (outername == "GB   " && value == 478)
		return "40.00";
	if (outername == "GB    " && value == 299)
		return "25.00";
	if (outername == "GB     " && value == 276)
		return "23.08";
	if (outername == "GB      " && value == 1150)
		return "96.30";
	if (outername == "GB       " && value == 187)
		return "15.63";
	if (outername == "GB        " && value == 597)
		return "50.00";
	
	if (outername == "SUCC" && value == 1167)
		return "284";
	if (outername == "SUCC " && value == 411)
		return "100";
	if (outername == "SUCC  " && value == 2255)
		return "549";
	if (outername == "SUCC   " && value == 637)
		return "155";
	if (outername == "SUCC    " && value == 440)
		return "107";
	if (outername == "SUCC     " && value == 1602)
		return "390";
	if (outername == "SUCC      " && value == 612)
		return "149";
	if (outername == "SUCC       " && value == 592)
		return "144";
	if (outername == "SUCC        " && value == 1384)
		return "337";
...
function drawMarkingArcs(arcs) {
	drawMarkingArc(arcs, 0, 1.595, "#B7695C", "0", "Subbagging");
	drawMarkingArc(arcs, 9, 3.19, "#FFB85F", "1", "Gentle Boost");
...
d3.json('chord-sclb/lotr_words_location_sclb.json', function (error, dataAgg) {
	...
	var innerLabels = g.append("g")
	  ...
	  .enter().append("text")
		...
		$('text[class="name-title"]').html("S-CLB").css("font-size", "25").css("left", "1000px").parent().css("opacity", 1);
